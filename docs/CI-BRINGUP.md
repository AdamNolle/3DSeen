...
- CI pins Xcode 16.4, GitHub Actions by commit SHA, and checksum-verified XcodeGen 2.45.4 / SwiftLint 0.65.0 release binaries.
...
3. If the `macos-15` image removes Xcode 16.4, deliberately advance the pinned version and rerun the full matrix; do not return to `latest-stable`.
